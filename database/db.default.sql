...
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AF', 'Afghanistan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AL', 'Albania');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('DZ', 'Algeria');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('DS', 'American Samoa');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AD', 'Andorra');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AO', 'Angola');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AI', 'Anguilla');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AQ', 'Antarctica');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AG', 'Antigua and Barbuda');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AR', 'Argentina');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AM', 'Armenia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AW', 'Aruba');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AU', 'Australia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AT', 'Austria');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AZ', 'Azerbaijan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BS', 'Bahamas');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BH', 'Bahrain');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BD', 'Bangladesh');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BB', 'Barbados');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BY', 'Belarus');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BE', 'Belgium');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BZ', 'Belize');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BJ', 'Benin');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BM', 'Bermuda');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BT', 'Bhutan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BO', 'Bolivia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BA', 'Bosnia and Herzegovina');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BW', 'Botswana');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BV', 'Bouvet Island');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BR', 'Brazil');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('IO', 'British Indian Ocean Territory');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BN', 'Brunei Darussalam');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BG', 'Bulgaria');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BF', 'Burkina Faso');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('BI', 'Burundi');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('KH', 'Cambodia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CM', 'Cameroon');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CA', 'Canada');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CV', 'Cape Verde');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('KY', 'Cayman Islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CF', 'Central African Republic');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TD', 'Chad');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CL', 'Chile');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CN', 'China');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CX', 'Christmas Island');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CC', 'Cocos (Keeling) Islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CO', 'Colombia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('KM', 'Comoros');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CG', 'Congo');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CK', 'Cook Islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CR', 'Costa Rica');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('HR', 'Croatia (Hrvatska)');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CU', 'Cuba');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CY', 'Cyprus');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CZ', 'Czech Republic');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('DK', 'Denmark');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('DJ', 'Djibouti');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('DM', 'Dominica');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('DO', 'Dominican Republic');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TP', 'East Timor');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('EC', 'Ecuador');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('EG', 'Egypt');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SV', 'El Salvador');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GQ', 'Equatorial Guinea');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('ER', 'Eritrea');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('EE', 'Estonia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('ET', 'Ethiopia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('FK', 'Falkland Islands (Malvinas)');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('FO', 'Faroe Islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('FJ', 'Fiji');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('FI', 'Finland');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('FR', 'France');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('FX', 'France, Metropolitan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GF', 'French Guiana');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PF', 'French Polynesia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TF', 'French Southern Territories');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GA', 'Gabon');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GM', 'Gambia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GE', 'Georgia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('DE', 'Germany');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GH', 'Ghana');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GI', 'Gibraltar');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GK', 'Guernsey');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GR', 'Greece');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GL', 'Greenland');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GD', 'Grenada');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GP', 'Guadeloupe');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GU', 'Guam');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GT', 'Guatemala');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GN', 'Guinea');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GW', 'Guinea-Bissau');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GY', 'Guyana');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('HT', 'Haiti');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('HM', 'Heard and Mc Donald Islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('HN', 'Honduras');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('HK', 'Hong Kong');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('HU', 'Hungary');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('IS', 'Iceland');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('IN', 'India');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('IM', 'Isle of Man');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('ID', 'Indonesia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('IR', 'Iran (Islamic Republic of)');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('IQ', 'Iraq');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('IE', 'Ireland');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('IL', 'Israel');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('IT', 'Italy');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CI', 'Ivory Coast');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('JE', 'Jersey');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('JM', 'Jamaica');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('JP', 'Japan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('JO', 'Jordan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('KZ', 'Kazakhstan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('KE', 'Kenya');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('KI', 'Kiribati');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('KP', 'Korea, Democratic People''s Republic of');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('KR', 'Korea, Republic of');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('XK', 'Kosovo');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('KW', 'Kuwait');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('KG', 'Kyrgyzstan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('LA', 'Lao People''s Democratic Republic');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('LV', 'Latvia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('LB', 'Lebanon');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('LS', 'Lesotho');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('LR', 'Liberia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('LY', 'Libyan Arab Jamahiriya');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('LI', 'Liechtenstein');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('LT', 'Lithuania');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('LU', 'Luxembourg');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MO', 'Macau');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MK', 'Macedonia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MG', 'Madagascar');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MW', 'Malawi');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MY', 'Malaysia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MV', 'Maldives');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('ML', 'Mali');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MT', 'Malta');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MH', 'Marshall Islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MQ', 'Martinique');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MR', 'Mauritania');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MU', 'Mauritius');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TY', 'Mayotte');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MX', 'Mexico');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('FM', 'Micronesia, Federated States of');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MD', 'Moldova, Republic of');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MC', 'Monaco');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MN', 'Mongolia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('ME', 'Montenegro');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MS', 'Montserrat');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MA', 'Morocco');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MZ', 'Mozambique');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MM', 'Myanmar');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('NA', 'Namibia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('NR', 'Nauru');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('NP', 'Nepal');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('NL', 'Netherlands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AN', 'Netherlands Antilles');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('NC', 'New Caledonia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('NZ', 'New Zealand');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('NI', 'Nicaragua');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('NE', 'Niger');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('NG', 'Nigeria');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('NU', 'Niue');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('NF', 'Norfolk Island');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('MP', 'Northern Mariana Islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('NO', 'Norway');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('OM', 'Oman');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PK', 'Pakistan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PW', 'Palau');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PS', 'Palestine');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PA', 'Panama');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PG', 'Papua New Guinea');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PY', 'Paraguay');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PE', 'Peru');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PH', 'Philippines');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PN', 'Pitcairn');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PL', 'Poland');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PT', 'Portugal');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PR', 'Puerto Rico');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('QA', 'Qatar');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('RE', 'Reunion');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('RO', 'Romania');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('RU', 'Russian Federation');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('RW', 'Rwanda');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('KN', 'Saint Kitts and Nevis');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('LC', 'Saint Lucia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('VC', 'Saint Vincent and the Grenadines');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('WS', 'Samoa');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SM', 'San Marino');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('ST', 'Sao Tome and Principe');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SA', 'Saudi Arabia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SN', 'Senegal');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('RS', 'Serbia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SC', 'Seychelles');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SL', 'Sierra Leone');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SG', 'Singapore');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SK', 'Slovakia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SI', 'Slovenia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SB', 'Solomon Islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SO', 'Somalia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('ZA', 'South Africa');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GS', 'South Georgia South Sandwich Islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SS', 'South Sudan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('ES', 'Spain');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('LK', 'Sri Lanka');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SH', 'St. Helena');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('PM', 'St. Pierre and Miquelon');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SD', 'Sudan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SR', 'Suriname');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SJ', 'Svalbard and Jan Mayen Islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SZ', 'Swaziland');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SE', 'Sweden');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('CH', 'Switzerland');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('SY', 'Syrian Arab Republic');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TW', 'Taiwan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TJ', 'Tajikistan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TZ', 'Tanzania, United Republic of');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TH', 'Thailand');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TG', 'Togo');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TK', 'Tokelau');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TO', 'Tonga');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TT', 'Trinidad and Tobago');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TN', 'Tunisia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TR', 'Turkey');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TM', 'Turkmenistan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TC', 'Turks and Caicos Islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('TV', 'Tuvalu');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('UG', 'Uganda');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('UA', 'Ukraine');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('AE', 'United Arab Emirates');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('GB', 'United Kingdom');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('US', 'United States');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('UM', 'United States minor outlying islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('UY', 'Uruguay');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('UZ', 'Uzbekistan');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('VU', 'Vanuatu');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('VA', 'Vatican City State');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('VE', 'Venezuela');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('VN', 'Vietnam');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('VG', 'Virgin Islands (British)');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('VI', 'Virgin Islands (U.S.)');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('WF', 'Wallis and Futuna Islands');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('EH', 'Western Sahara');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('YE', 'Yemen');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('ZR', 'Zaire');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('ZM', 'Zambia');
INSERT INTO `user_country`('abbreviation', 'name') VALUES ('ZW', 'Zimbabwe');




INSERT INTO `user_state` (`id`, `name`, `abbreviation`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
INSERT INTO `user_city` (`id`, `name`, `state_id`) VALUES
(1, 'Afonso Cláudio', 8),
...
INSERT INTO 'user_payment_situation'('id', 'description', 'description_details') VALUES ('1', 'Awaiting payment', 'O comprador iniciou a transação, mas até o momento o PagSeguro não recebeu nenhuma informação sobre o pagamento. Quando a resposta da instituição financeira é muito rápida, omitimos esta notificação.');
INSERT INTO 'user_payment_situation'('id', 'description', 'description_details') VALUES ('2', 'Under analysis', 'O comprador optou por pagar com um cartão de crédito e o PagSeguro está analisando o risco da transação.');
INSERT INTO 'user_payment_situation'('id', 'description', 'description_details') VALUES ('3', 'pay', 'A transação foi paga pelo comprador e o PagSeguro já recebeu uma confirmação da instituição financeira responsável pelo processamento. Porém, o valor da transação pode ainda não estar disponível para retirada de sua conta, pois o PagSeguro pode esperar o fim do prazo de liberação da transação.');
INSERT INTO 'user_payment_situation'('id', 'description', 'description_details') VALUES ('4', 'Available', 'A transação foi paga e chegou ao final de seu prazo de liberação sem ter sido retornada e sem que haja nenhuma disputa aberta. Este status indica que o valor da transação está disponível para saque.');
INSERT INTO 'user_payment_situation'('id', 'description', 'description_details') VALUES ('5', 'In dispute', 'O comprador, dentro do prazo de liberação da transação, abriu uma disputa. A disputa é um processo iniciado pelo comprador para indicar que não recebeu o produto ou serviço adquirido, ou que o mesmo foi entregue com problemas. Este é um mecanismo de segurança oferecido pelo PagSeguro. A equipe do PagSeguro é responsável por mediar a resolução de todas as disputas, quando solicitado pelo comprador. Para mais informações, veja a página de explicação sobre disputas.');
INSERT INTO 'user_payment_situation'('id', 'description', 'description_details') VALUES ('6', 'Returned', 'O valor da transação foi devolvido para o comprador. Se você não possui mais o produto vendido em estoque, ou não pode por alguma razão prestar o serviço contratado, você pode devolver o valor da transação para o comprador. Esta também é a ação tomada quando uma disputa é resolvida em favor do comprador. Transações neste status não afetam o seu saldo no PagSeguro, pois não são nem um crédito e nem um débito.');
INSERT INTO 'user_payment_situation'('id', 'description', 'description_details') VALUES ('7', 'Canceled', 'A transação foi cancelada sem ter sido finalizada. Quando o comprador opta por pagar com débito online ou boleto bancário e não finaliza o pagamento, a transação assume este status. Isso também ocorre quando o comprador escolhe pagar com um cartão de crédito e o pagamento não é aprovado pelo PagSeguro ou pela operadora.');
INSERT INTO 'user_payment_situation'('id', 'description', 'description_details') VALUES ('8', 'Debited', 'A valor da transação foi devolvido para o comprador.');
INSERT INTO 'user_payment_situation'('id', 'description', 'description_details') VALUES ('9', 'Temporary retention', 'O comprador abriu uma solicitação de chargeback junto à operadora do cartão de crédito.');
/*
INSERT INTO 'user_titulacao'('id', 'titulo') VALUES 
('1', "Technical"),
('2', "Undergraduate"),
('3', "Master's degree"),
('4', "PhD"),
...
/*
INSERT INTO 'user_area'('id', 'name') VALUES 
...
*/
INSERT INTO 'user_evaluation_status' VALUES
(1,'Submitted'),
(2,'Approved'),
